...
namespace SubwayTalentApi.Filters
{
    ...
    public class GenericAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext filterContext)
        {
            ...
            if (!OnAuthorizeUser(identity.Name, identity.Password, identity.AccessToken))
            {
                ChallengeAuthRequest(filterContext);
                return;
            }
        ...
        /// <param name="filterContext"></param>
        /// <returns></returns>
        protected virtual bool OnAuthorizeUser(string userId, string pass, string accessToken)
        {
        ...
        protected virtual BasicAuthenticationIdentity FetchAuthHeader(HttpActionContext filterContext)
        {
            ...
            if (authRequest != null && !String.IsNullOrEmpty(authRequest.Scheme) && authRequest.Scheme == "SubwayTalentAuth")
            ...
            var credentials = authHeaderValue.Split(':');
            return credentials.Length < 3 ? null : new BasicAuthenticationIdentity(credentials[0], credentials[1], credentials[2]);
        }
        ...
        private static void ChallengeAuthRequest(HttpActionContext filterContext)
        {
            ...
            filterContext.Response.Headers.Add("WWW-Authenticate", string.Format("SubwayTalentAuth realm=\"{0}\"", dnsHost));
        }
    }
}